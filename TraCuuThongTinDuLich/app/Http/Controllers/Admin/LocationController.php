...
class LocationController extends Controller
{
    ...
    public function create()
    {
        if(Auth::guard('admin')->check()){
            ...
            $data_form[] = $form->text('type','',0,'Loại hình du lịch','VD: Du lịch sinh thái');
    ...
    public function store(Request $request)
    {
        ...
        // dd($slides);
        $data_insert = compact(
            'name','slug','thumnail','slides','address','type','maps',
    ...
    public function edit(string $id)
    {
        if(Auth::guard('admin')->check()){
            ...
            $data_form[] = $form->text('type',$data_edit->type,0,'Loại hình du lịch','VD: Du lịch sinh thái');
