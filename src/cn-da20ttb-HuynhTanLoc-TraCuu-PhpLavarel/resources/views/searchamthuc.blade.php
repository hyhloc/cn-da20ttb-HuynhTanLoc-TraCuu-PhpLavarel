            ...
            <div class="container">
                <div class="flex">
                    <div class="box0">
                        ...
                        <b style="font-size: 20px;">Giờ mở cửa: </b><p style="font-size: 20px;">{!! $data->times??'' !!}</p>
                    </div>
                    <div class="box0">
                    ...
                    <div class="box0">
                        ...
                        <b style="font-size: 20px;">Tên quán: </b><p style="font-size: 20px;">{!! $data->name??'' !!}</p>
                    </div>
                    <div class="box0">
                        <i class="fa-solid fa-money-bill"></i>
                        <b style="font-size: 20px;">Giá dao động từng món : </b><p style="font-size: 20px;">{!! $data->price??'' !!}</p>
                    </div>
                    <div class="box0">
                    ...
                    <div class="box0">
                        ...
                        <b style="font-size: 20px;">Loại hình quán ăn: </b><p style="font-size: 20px;">{!! $data->type??'' !!}</p>
                    </div>
                </div>
            </div>
        </div>
