...
Route::get('/diadiem/{categories_id?}', [HomeController::class, 'categories'])->name('diadiem_category');

// Route::get('/danh-muc/{slug?}',[HomeController::class,'danhmuc'])->name('danhmuc');
// Route::get('/dia-diem/{dm}',[HomeController::class,'categories'])->name('categories');
